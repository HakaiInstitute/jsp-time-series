...
```{r migration-timing-plot, fig.cap = "Cumulative annual abundance of sockeye, pink, and chum, in the Discovery Islands and Johnstone Strait compared to the study-period average.", out.width="100%"}
cols <-
  c(
    "2018" = "#aa1f25",
    "2017" = "#a58457",
