...
theme_set(ggsidekick::theme_sleek(base_size = 16)) #Thanks Sean Anderson, package hosted on GitHub
...
Add clarifying sentence here about why abundance and catch intensity is based on seines that contained sockeye.
  ...
  Species proportions were calculated by dividing the total number of each species caught by the sum of all species caught that season. Only seines that caught sockeye were used in the calculation of species for the same reason stated previously. To test whether fork lengths from `r current_year` were significantly different than the study-period averages, an independent two-group t-test was conducted. Fork length distributions were visualized by calculating length frequency distributions using kernel density estimates from fork length data.
...
ggplot(heatmap_data, aes(year, spp, colour = Z)) +
  ...
  labs(title = "Migration Observations",
    subtitle = "Migration parameter variability 2015-2018") +
  #theme(panel.grid.major.y= element_line("grey")) +
  facet_wrap(. ~ measure, ncol = 1, scales = "free")

ggsave(here("figs", "heatmap.png"), width = 11, height = 12)
```


```{r migration-timing-plot, fig.cap = "Cumulative annual abundance of sockeye, pink, and chum, in the Discovery Islands and Johnstone Strait compared to the study-period average.", out.width="90%"}
cols <-
  c(
    "2018" = "#aa1f25",
    "2017" = "#a58457",
...
```{r sst-plot, out.width="90%", fig.cap="Sea-surface temperature (top 30 m) at station QU39 in the northern Strait of Georgia is the solid black line which is a LOESS regression based on temperatures from 2015-2018 representing the study period average. Blue areas represent temperatures from 2018 that are below average, red areas represent above average temperatures. The shaded grey area is 1 SE of the LOESS regression. The black dots are the daily minimum and maximum temperatures observed over the study period."}
...
ggplot(data = temperature_anomaly_data, aes(x = yday, y = mean_temp)) +
  ...
  labs(title = "2018 Temperatures",
       subtitle = "2018 compared to study period average") 
