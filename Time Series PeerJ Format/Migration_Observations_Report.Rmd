...
#TODO: Bootstrap sealice confidence intervals, because the dist. are not normal
...
# Introduction
  ...
  The first months after marine entry have been identified as a potentially critical period for salmon stock recruitment [@Beamish2001], which may ultimately be responsible for inter-annual variability and long-term declines in British Columbian salmon stocks [@Peterman2010; @Beamish2012]. The leading causes of the decline have emerged as the impacts of climate change on marine food web dynamics, followed by pathogens and predators. (#TODO: add reference). The Hakai Institute Juvenile Salmon Program has been monitoring juvenile salmon migrations in the Discovery Islands and Johnstone Strait (Figure \@ref(fig:map)) since 2015 in an effort to understand the factors that are influencing early marine survival of sockeye, pink, and chum [@Hunt2018]. This report summarizes migration timing, fish length, parasite loads, species composition, and sea-surface temperature observed from the first `r project_years` years of this research and monitoring program. These estimates will provide context to investigate questions and interpret results related to growth, survival, and the conditions salmon experience during their migration through this critical region. 
...
df <- lice_bootstraps %>% 
  ...
  summarize(mean_abund = mean(estimate),
            lower_ci = mean(estimate),
            upper_ci = mean(estimate),
            n = n())
...
#TODO:  recode species names
#TODO: relevel factor levels to be Sockeye, Pink, Chum
