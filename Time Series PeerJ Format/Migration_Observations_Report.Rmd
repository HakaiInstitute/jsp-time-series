...
cu_cum_abund_annual_DI_2017 <- read_csv(here("data", "cu_cum_abund_annual_DI_2017.csv"))
# Length Data
...
=======
  geom_point(data = cu_cum_abund_2017, aes(x = survey_date, y = percent, colour = factor(year))) + 
...
ggsave(here("figs", "sealice_abundance"))
```
