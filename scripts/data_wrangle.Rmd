...
qu39_temp_anomaly_data <-
  ...
  add_row(
    station = "QU39",
    yday = (155 + 171) / 2,
    predicted_mean_temp = predict(temp.lo_qu39, (155 + 171) / 2),
    mean_temp = predict(temp.lo_qu39, (155 + 171) / 2)
  ) %>% 
  add_row(
    station = "QU39",
    yday = (176 + 184) / 2,
  ...
  add_row(
    station = "QU39",
    yday = (211 + 199) / 2,
    predicted_mean_temp = predict(temp.lo_qu39, (211 + 199) / 2),
    mean_temp = predict(temp.lo_qu39, (211 + 199) / 2)
  )
