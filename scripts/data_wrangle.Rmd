...
A DOI citable version of the data in the R package can be formall requested [here](http://dx.doi.org/10.21966/1.566666).
...
# Downloads and unpacks the .zip of JSP Data v.1.0.2 from the Hakai Metadata Catalogue, DOI http://dx.doi.org/10.21966/1.566666 Change the version number and re-download when there is an update released.

# drive_download(as_id("https://driv.ejsp-datgaoogle.com/open?id=1dSaGlM9Em6Lo9_jfL9qO7nnm8pdjMYNf"),
#                path = here("data", "v1.0.2.zip"),
#                overwrite = TRUE)

sites <- read_csv("https://raw.githubusercontent.com/HakaiInstitute/jsp-data/release/1.1.0/data/sites.csv")

survey_data <- read_csv("https://raw.githubusercontent.com/HakaiInstitute/jsp-data/release/1.1.0/data/survey_data.csv") %>% 
...
seine_data <- read_csv("https://raw.githubusercontent.com/HakaiInstitute/jsp-data/release/1.1.0/data/seine_data.csv")
...
fish_field_data <- read_csv("https://raw.githubusercontent.com/HakaiInstitute/jsp-data/release/1.1.0/data/fish_field_data.csv", guess_max = 20000)

survey_seines_fish <- left_join(survey_seines, fish_field_data, by = "seine_id") %>% 
  drop_na(ufn)

sealice_field_data <- read_csv("https://raw.githubusercontent.com/HakaiInstitute/jsp-data/release/1.1.0/data/sealice_field.csv")
...
sealice_lab_mot <- read_csv("https://raw.githubusercontent.com/HakaiInstitute/jsp-data/release/1.1.0/data/sealice_lab_mot.csv")

sealice_lab_fs_mot <- read_csv("https://raw.githubusercontent.com/HakaiInstitute/jsp-data/release/1.1.0/data/sample_results/sealice_lab_fs.csv") %>% 
...
field_lice <- survey_seines_fish %>% 
  left_join(sealice_field_data, by = "ufn") %>%
...
write_csv(sealice_summary_table, here("data", "sealice_summary_table.csv"))
...
#TODO: Write function for intensity and prevalence
...
fish_lab_data <- read_csv(unzip(here("data", "v1.0.2.zip"), 
                                files = "data/fish_lab_data.csv", 
                                exdir = here("data", "v1.0.2"),
                                overwrite = TRUE), guess_max = 5000)
