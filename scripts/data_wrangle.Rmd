...
sealice_field <- read_csv("../../jsp-data-packages/data/sealice_field.csv")
...
sealice_lab_mot <- read_csv("../../jsp-data-packages/data/sealice_lab_mot.csv")
sealice_lab_fs_mot <- read_csv("../../jsp-data-packages/data/sealice_lab_fs.csv") %>% 
...
fish_field_data <- read_csv("../../jsp-data-packages/data/fish_field_data.csv", guess_max = 10000)
