...
```{r condition-plot, fig.cap=paste("Length and weight regressions for juvenile salmon caught in the Discovery Islands and Johnstone Strait in", current_year, "coloured red, compared to all outher years in black.")}
library(cowplot)
library(ggpubr)
