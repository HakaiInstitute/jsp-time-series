...
sst_time_series_stats <- sst_time_series %>%
  filter(year != current_year)

sst_current_year <- sst_time_series %>% 
  filter(year == current_year)
...
Ocean temperature in the top 30 m of the water column in May and June during the juvenile salmon out-migration at QU39 in the northern Strait of Georgia was `r round(sst_stats_table$estimate, 2)` degrees C warmer OR COLDER? than average.
...
```{r sst-plot, out.width="90%", fig.cap="Thirty-meter depth-integrated ocean temperatures at station QU39 in the northern Strait of Georgia is the solid black line which represents average temperatures from 2015–2019. Blue areas represent temperatures from 2019 that are below the 2015–2019 average and red areas represent above average temperatures. The shaded grey area is 1 SE of the loess regression. The black dots are the minimum and maximum daily mean temperatures observed over the study-period."}
